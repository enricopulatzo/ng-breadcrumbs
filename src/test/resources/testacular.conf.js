...
files = [
  ...
  'test/javascript/lib/angular-1.0.3/angular.js',
  'test/javascript/lib/angular-1.0.3/angular-mocks.js',

  'main/resources/META-INF/resources/javascript/ng-breadcrumbs.js',
  'test/javascript/unit/ngBreadcrumbsSpec.js'
];
